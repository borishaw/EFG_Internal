    ...
    <tr height="60">
        ...
        <td>
			 <span style="font-family:'Trebuchet MS',helvetica,San-Serif;font-size:11px;color:#888888;line-height:20px;">
				  <b style="color:#d40404;text-transform:uppercase;letter-spacing:2px"><?php echo $_POST['fname'] ?>&nbsp;<?php echo $_POST['mname'] ?>&nbsp;<?php echo $_POST['lname'] ?></b><?php
                 if ($_POST['title'] != '') {
                     echo '/&nbsp;' . $_POST['title'];
                 } ?>
			 </span>
			 ...
			 <span style="font-family:'Trebuchet MS',helvetica,San-Serif;font-size:11px;color:#888888;line-height: 40px;"><a href="<?php
                 ...
                 ?>" title="Connect On Linked In"><img src="http://www.ankitdesigns.com/email_sig/images/li.jpg"/></a>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="results-code" contentEditable="false">
