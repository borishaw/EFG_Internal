...
?>
                 ...
                 ?>" title="Connect On Linked In"><img src="http://www.ankitdesigns.com/email_sig/images/li.jpg"/></a>
                    ...
                    <div class="tab-content-item steps">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="step-item">
                                    <h2><a href="#gmail-step-one" class="open-popup-link">Step One: Copying HTML
                                            Signature <i class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#gmail-step-two" class="open-popup-link">Step Two: Open Gmail Settings
                                            <i class="fa fa-picture-o"></i></a></h2>

                                    <p>In Gmail, Click the Machine Bearing icon on the upper right hand side. Then
                                        select 'Settings' from the dropdown menu.</p>
                                </div>
                                <div class="step-item">
                                    <h2><a href="#gmail-step-three" class="open-popup-link">Step Three: Paste HTML
                                            Signatue and Save <i class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#gmail-step-four" class="open-popup-link">Step Four: Check installation
                                            <i
                    ...
                    <div class="tab-content-item steps">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="step-item">
                                    <h2><a href="#macmail-step-one" class="open-popup-link">Step One: Copying HTML
                                            Signature <i class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#macmail-step-two" class="open-popup-link">Step Two: Create Placeholder
                                            Signature in Mail <i class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#macmail-step-three" class="open-popup-link">Step Three: Open The
                                            Signatures Folder <i class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#macmail-step-four" class="open-popup-link">Step Four: Update
                                            Placeholder Signature <i class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#macmail-step-five" class="open-popup-link">Step Five: Lock Updated
                                            Signature File – IMPORTANT <i class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#macmail-step-six" class="open-popup-link">Step Six: Check Installation
                                            <i class="fa fa-picture-o"></i></a></h2>
                    ...
                    <div class="tab-content-item steps">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="step-item">
                                    <h2><a href="#outlook-step-two" class="open-popup-link">Step Two <i
                                                class="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#outlook-step-four" class="open-popup-link">Step Four
                                            <iclass
                                            ="fa fa-picture-o"></i></a></h2>
                                ...
                                <div class="step-item">
                                    <h2><a href="#outlook-step-five" class="open-popup-link">Step Five <i
                                                class="fa fa-picture-o"></i></a></h2>
    ...
    <div id="macmail-step-two" class="popup-container mfp-hide zoom-anim-dialog">
        ...
        <div class="popup-text">
            ...
            <p>In Mail.app, open Preferences and click on the Signatures tab. There you will see 3 columns, the 1st one
                are your mail box accounts, the 2nd one are your custom signatures and the 3rd column is the signature
                detail preview. Create a new placeholder signature by clicking on the plus icon at the bottom of the 2nd
                column and name it. Drag your new signature from column 2 into your preferred mail box in column 1.
                Select your preferred mail box in the first column and go down to Choose Signature at the bottom. In the
                drop down menu, find and select your new signature. Note: At this point you will not see your HTML
                signature design on the 3rd column yet. Leave the 3rd column as is for now. Close window and quit
                Mail.app.</p>
        </div>
    </div>
    <div id="macmail-step-three" class="popup-container mfp-hide zoom-anim-dialog">
        ...
        <div class="popup-text">
            ...
            <p>On Finder’s top navigation, drop down the Go menu and than hold down the Option key to see the hidden
                Library folder. Once the Library folder is open, go to: ~/Library/Mail/V2/MailData/Signatures/.</p>
        </div>
    </div>
    <div id="macmail-step-four" class="popup-container mfp-hide zoom-anim-dialog">
        ...
        <div class="popup-text">
            ...
            <p>Find the signature that you just added (a file ending with a .mailsignature extension). If there are
                multiple files in the folder, switch to list view. The signature that you just added in Mail.app should
                be the file that with the most recent modified date. When you have located the .mailsignature file, open
                it with TextEdit. You may see some metadata info on top and some HTML code below it. Delete all the HTML
                code (highlighted in picture below) and leave the metadata info untouched.

                Under the metadata info, paste the HTML code of your email signature (Read bottom of Step 1 for
                instructions on how to reveal and copy the HTML code of your email signature design with Safari). Hit
    ...
    <div id="macmail-step-five" class="popup-container mfp-hide zoom-anim-dialog">
        ...
        <div class="popup-text">
            ...
            <p>This step must be followed correctly in order for this signature to work or else Mail.app will use the
                original version of the signature instead of the new one. Locate the .mailsignature file that you just
                updated in Finder again. Press Command+I or right click on file to Get Info. In the Get Info window,
                mark the Locked check box.</p>
        </div>
    </div>
    <div id="macmail-step-six" class="popup-container mfp-hide zoom-anim-dialog">
        ...
        <div class="popup-text">
            ...
            <p>Restart Mail.app. Your new custom signature should appear automatically when you click on Compose Mail.
                If not, make sure you have followed Step 2 correctly. Links will not work and the images if any may not
                show when composing an email. But the links will work and the images will show on the receiving end if
                the source locations are correct. Compose and send yourself a test email with your new signature
                selected. If the images show, the links working and everything looks as it should, then you have done
                this correctly. Good Job!</p>
        </div>
    </div>
    ...
    <div id="outlook-step-two" class="popup-container mfp-hide zoom-anim-dialog">
        ...
        <div class="popup-text">
            ...
            <p>With the browser open with your signature displaying properly, press Command + A on your keyboard to
                “Select All” and then press Command + C to copy the signature.</p>
        </div>
    </div>
    <div id="outlook-step-four" class="popup-container mfp-hide zoom-anim-dialog">
        ...
        <div class="popup-text">
            ...
            <p>Create a new signature by clicking the “+” button. If there is content in the window on the right after
                you’ve clicked the “+” button, delete it all. *Normally it will display your first and last name in
                plain text, just delete it.</p>
        </div>
    </div>
