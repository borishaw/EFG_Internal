...
<head lang="en">
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Ankit Designs">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
	 
    <title>Email Footer Generator | Ankit Designs</title>
	...
	<meta name="msapplication-TileColor" content="#cf2127">
	<meta name="msapplication-TileImage" content="favicons/mstile-144x144.png">
	<meta name="msapplication-config" content="favicons/browserconfig.xml">
	<meta name="theme-color" content="#cf2127">
	 
	 <!-- Stylesheets -->
	 <link rel="stylesheet" type="text/css" href="css/lib/reset.css"> <!-- Reset CSS -->
	 <link rel="stylesheet" type="text/css" href="css/lib/bootstrap.min.css"> <!-- Bootstrap -->
